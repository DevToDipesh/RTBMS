...
class HospitalFragment : Fragment(), OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_hospitals, container, false)

        val dataTransfer = arrayOfNulls<Any>(2)
        val pharmacy = "hospital"
    ...
    companion object {
        ...
        private var instance: HospitalFragment?= null
        fun getInstance(): Fragment {
            if (instance == null) {
                instance = HospitalFragment()
            }
            return instance!!
        }
    }
